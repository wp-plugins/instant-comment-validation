...
1. Validation error message showing in Twenty Fourteen Theme to logged in user
2. Validation error message showing in Twenty Fourteen Theme to general user
